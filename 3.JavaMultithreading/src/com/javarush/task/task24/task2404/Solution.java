...
//        System.out.println(getWidth(rectangle));
    ...
    public static class Rectangle extends Solution {
        ...
        public HasHeight castToHasHeight() {
            class LocalCastToHasHeight implements HasHeight {
                @Override
            ...
            return new LocalCastToHasHeight();
        }

        public HasWidth castToHasWidth() {
            class LocalCastToHasWidth implements HasWidth {
                @Override
                public double getWidth() {
                    return Math.abs(point1.getX() - point2.getX());
                }
            }
            return new LocalCastToHasWidth();
        }
    }
}
