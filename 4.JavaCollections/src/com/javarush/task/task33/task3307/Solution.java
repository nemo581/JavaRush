...
//        StringReader xmldate = new StringReader(xmlData);
//        JAXBContext context = JAXBContext.newInstance(clazz);
//        Unmarshaller unmarshaller = context.createUnmarshaller();
//        T t = (T) unmarshaller.unmarshal(xmldate);
        return clazz.cast(JAXBContext.newInstance(clazz).createUnmarshaller().unmarshal(new StringReader(xmlData)));
    }
